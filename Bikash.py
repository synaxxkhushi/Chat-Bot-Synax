            ...
            [
                [
                    InlineKeyboardButton(
                        "🧸 ❰ 𝐀𝐝𝐝 𝐦𝐞 𝐁𝐚𝐛𝐲 ❱ 🧸", url=f"https://t.me/{BOT_USERNAME}?startgroup=true")
                ]
    ...
    await message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        " 🧸 ᴊᴏɪɴ ᴏᴜʀ ᴄʜᴀɴɴᴇʟ 🧸", url=f"https://t.me/synaxnetwork")
                ]
            ]
        ),
    )
...
async def chatboton(client, message):
    ...
    is_v = v.find_one({"chat_id": message.chat.id})
    if not is_v:           
        await message.reply_text(f"💥 𝐕 𝐂𝐡𝐚𝐭𝐛𝐨𝐭 𝐈𝐬 𝐀𝐥𝐫𝐞𝐚𝐝𝐲 𝐄𝐧𝐚𝐛𝐥𝐞𝐝🌷!")
    if is_v:
